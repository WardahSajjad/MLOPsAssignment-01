...
data = {
    'Age': 25,  # Example age
    'Gender': 0,  # Assuming 0 represents Male and 1 represents Female, for example
    ...
    'Educational Qualifications': 3,  # Assuming 3 represents the encoded value for educational level
